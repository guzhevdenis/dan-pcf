#+======================================================================
# $HeadURL: https://svnpub.codac.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/branches/codac-core-6.3/src/main/resources/util.sh $
# $Id: util.sh 116150 2021-01-04 09:45:04Z kimh19 $
#
